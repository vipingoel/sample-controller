...
// CrdV1alpha1Client is used to interact with features provided by the crd.example.com group.
type CrdV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CrdV1alpha1Client) Compositions(namespace string) CompositionInterface {
